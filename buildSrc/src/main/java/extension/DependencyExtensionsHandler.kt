...
val DependencyHandler.GENRE
    get() = implementation(project(mapOf("path" to ":feature:genre")))
val DependencyHandler.MOVIE
    get() = implementation(project(mapOf("path" to ":feature:movie")))